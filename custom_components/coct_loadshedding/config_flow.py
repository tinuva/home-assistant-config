"""Adds config flow for the CoCT Loadshedding Interface."""
...
class CoCTFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    def async_get_options_flow(config_entry):
        return CoCTOptionsFlowHandler(config_entry)
...
class CoCTOptionsFlowHandler(config_entries.OptionsFlow):
    """CoCT config flow options handler."""
